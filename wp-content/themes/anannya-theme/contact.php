   ...
   <div class="row">
      ...
      <div class="offset-xl-1 col-xl-7 offset-lg-1 col-lg-7 col-md-6 com-sm-6 col-12 n_contains">
         ...
         <div class="n_contentCon">
          <img class="n_iconImMap" src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/02/address-1.png">
             <span class="n_iconTxMap">One Gateway Center, Suite 25500+,Newark 23, NJ 10235 </span>
          
          </div>
          
           <div class="n_contentCon">
          &nbsp;<img class="n_iconImEm" src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/02/mail.png">
          ...
          <div class="n_contentCon">
          &nbsp;<img class="n_iconImPhn" src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/02/phone.png">
      ...
      <div class="col-xl4 col-lg-4 col-md-6 col-sm-6 col-12 n_sidebar_marginCon">
