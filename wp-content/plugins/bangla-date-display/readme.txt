...
== Description == 
Displays Bangla, Gregorian and Hijri date, time, name of the day, name of the current season of Bangladesh etc in Bangla language! Options available for displaying post/page's default (english) time, date, comment count, numbers etc in bangla language!
...
* Wrong bangla date problem solved for January, February & March.
* Bug fixed.

= 8.7 =
* Compatible with WP 5.3.
* Archive Calendar bangla convert feature removed.
* Bangla Monthly Calendar widgets removed.
* Backend number/date/time bangla convert feature removed.

= 8.6 =
* Bangla date calculation rules updated according to Bangla Academy.
* Tested Compatibility with WP 5.2.
